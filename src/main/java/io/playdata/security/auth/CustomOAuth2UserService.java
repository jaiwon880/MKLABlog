...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public CustomOAuth2UserService(AccountRepository userRepository, HttpSession httpSession) {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        AccountDTO user = saveOrUpdate(attributes);
    ...
    private AccountDTO saveOrUpdate(OAuthAttributes attributes) {
        AccountDTO user = userRepository.findByEmail(attributes.getEmail())
